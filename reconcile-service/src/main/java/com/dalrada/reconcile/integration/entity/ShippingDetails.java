 ...
 */
@Entity
@Table(name = "shipping",uniqueConstraints = {@UniqueConstraint(columnNames = {
		"invoiceNumber" 
})})
public class ShippingDetails implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -9197701566479488231L;
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Id
	@Column
	private Long shipDetID ;
	@Column
	...
	public Long getShipDetID() {
		return shipDetID;
	}
	public void setShipDetID(Long shipDetID) {
		this.shipDetID = shipDetID;
	}
	...
	public String toString() {
		...
		builder.append("ShippingDetails [shipDetID=").append(shipDetID).append(", invoiceNumber=").append(invoiceNumber)
