 ...
 */
@Component
public class OrderNoQuoteBeanBuilder implements OderBeanBuilder{

	public  OrderDetails buildBean(String record){
		List<String> itemList = Arrays.asList(record.split(",")).stream()
				.collect(Collectors.toList());
		List<String> list = new CopyOnWriteArrayList<String>(itemList);
